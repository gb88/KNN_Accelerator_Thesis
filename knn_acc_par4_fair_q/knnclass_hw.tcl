...
# Thu Jul 10 20:54:40 CEST 2014
# DO NOT MODIFY


# 
# knnclass "knnclass" v1.0
# null 2014.07.10.20:54:40
# 
# 
...
add_interface_port Overflow1 Overflow1 export Input 1
...
add_interface_port Overflow0 Overflow0 export Input 1


# 
# connection point Overflow2
# 
add_interface Overflow2 conduit end
set_interface_property Overflow2 associatedClock clock
set_interface_property Overflow2 associatedReset ""
set_interface_property Overflow2 ENABLED true

add_interface_port Overflow2 Overflow2 export Input 1


# 
# connection point Drop2
# 
add_interface Drop2 conduit end
set_interface_property Drop2 associatedClock clock
set_interface_property Drop2 associatedReset ""
set_interface_property Drop2 ENABLED true

add_interface_port Drop2 Drop2 export Output 1


# 
# connection point DistReset2
# 
add_interface DistReset2 conduit end
set_interface_property DistReset2 associatedClock clock
set_interface_property DistReset2 associatedReset ""
set_interface_property DistReset2 ENABLED true

add_interface_port DistReset2 DistReset2 export Output 1


# 
# connection point Go2
# 
add_interface Go2 conduit end
set_interface_property Go2 associatedClock clock
set_interface_property Go2 associatedReset ""
set_interface_property Go2 ENABLED true

add_interface_port Go2 Go2 export Output 1


# 
# connection point Dist2
# 
add_interface Dist2 conduit end
set_interface_property Dist2 associatedClock clock
set_interface_property Dist2 associatedReset ""
set_interface_property Dist2 ENABLED true

add_interface_port Dist2 Dist2 export Input 16


# 
# connection point EndTSet2
# 
add_interface EndTSet2 conduit end
set_interface_property EndTSet2 associatedClock clock
set_interface_property EndTSet2 associatedReset ""
set_interface_property EndTSet2 ENABLED true

add_interface_port EndTSet2 EndTSet2 export Input 1


# 
# connection point Cl2
# 
add_interface Cl2 conduit end
set_interface_property Cl2 associatedClock clock
set_interface_property Cl2 associatedReset ""
set_interface_property Cl2 ENABLED true

add_interface_port Cl2 Cl2 export Input 4


# 
# connection point EndComp2
# 
add_interface EndComp2 conduit end
set_interface_property EndComp2 associatedClock clock
set_interface_property EndComp2 associatedReset ""
set_interface_property EndComp2 ENABLED true

add_interface_port EndComp2 EndComp2 export Input 1


# 
# connection point EndComp3
# 
add_interface EndComp3 conduit end
set_interface_property EndComp3 associatedClock clock
set_interface_property EndComp3 associatedReset ""
set_interface_property EndComp3 ENABLED true

add_interface_port EndComp3 EndComp3 export Input 1


# 
# connection point EndTSet3
# 
add_interface EndTSet3 conduit end
set_interface_property EndTSet3 associatedClock clock
set_interface_property EndTSet3 associatedReset ""
set_interface_property EndTSet3 ENABLED true

add_interface_port EndTSet3 EndTSet3 export Input 1


# 
# connection point Cl3
# 
add_interface Cl3 conduit end
set_interface_property Cl3 associatedClock clock
set_interface_property Cl3 associatedReset ""
set_interface_property Cl3 ENABLED true

add_interface_port Cl3 Cl3 export Input 4


# 
# connection point Dist3
# 
add_interface Dist3 conduit end
set_interface_property Dist3 associatedClock clock
set_interface_property Dist3 associatedReset ""
set_interface_property Dist3 ENABLED true

add_interface_port Dist3 Dist3 export Input 16


# 
# connection point Go3
# 
add_interface Go3 conduit end
set_interface_property Go3 associatedClock clock
set_interface_property Go3 associatedReset ""
set_interface_property Go3 ENABLED true

add_interface_port Go3 Go3 export Output 1


# 
# connection point Overflow3
# 
add_interface Overflow3 conduit end
set_interface_property Overflow3 associatedClock clock
set_interface_property Overflow3 associatedReset ""
set_interface_property Overflow3 ENABLED true

add_interface_port Overflow3 Overflow3 export Input 1


# 
# connection point Drop3
# 
add_interface Drop3 conduit end
set_interface_property Drop3 associatedClock clock
set_interface_property Drop3 associatedReset ""
set_interface_property Drop3 ENABLED true

add_interface_port Drop3 Drop3 export Output 1


# 
# connection point DistReset3
# 
add_interface DistReset3 conduit end
set_interface_property DistReset3 associatedClock clock
set_interface_property DistReset3 associatedReset ""
set_interface_property DistReset3 ENABLED true

add_interface_port DistReset3 DistReset3 export Output 1
